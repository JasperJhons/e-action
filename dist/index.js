...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.uploadFile = exports.downloadReports = exports.getJobData = exports.startRun = exports.createRun = exports.makeGetRequest = void 0;
const fs = __importStar(__nccwpck_require__(147));
...
const downloadReports = async (runId, reports) => {
...
const uploadFile = async (filePath) => {
    const file = await (0, node_fs_1.openAsBlob)(filePath);
    ...
    const data = (await (await makeServerRequest('/file/upload', requestData)).json());
...
const types_1 = __nccwpck_require__(77);
const promises_1 = __nccwpck_require__(670);
const waitForRunEnd = async (jobs) => {
    let errors = 0;
    let finished = false;
